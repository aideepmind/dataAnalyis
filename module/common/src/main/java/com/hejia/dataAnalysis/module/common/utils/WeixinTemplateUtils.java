...
public class WeixinTemplateUtils {
	...
	static {
		...
		ClassLoader cl = WeixinTemplateUtils.class.getClassLoader();
		while (kIt.hasNext()) {
			String key = kIt.next();
	...
	public static String getTemplate(String tempName, Map<String, String> dataMap) {
		return StringFormatUtils.format(tMap.get(tempName), dataMap);
	}
	...
	public static void main(String[] args) {
		...
		String tmp = WeixinTemplateUtils.getTemplate("stu_receive_invite", dataMap);
