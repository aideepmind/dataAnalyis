...
public class PinyinTokenFilter extends TokenFilter {
	...
	private HanyuPinyinOutputFormat outputFormat;//汉语拼音输出转换器[基于Pinyin4j]
	private boolean firstChar;//对于多音字会有多个拼音,firstChar即表示只取第一个,否则会取多个拼音
	private int minTermLength;//Term最小长度[小于这个最小长度的不进行拼音转换]
